  ...
  <SheetPrimitive.Portal>
    ...
    <SheetPrimitive.Content
      ...
      className={cn(
        ...
        {
          'bottom-0 left-0 right-0 data-[state=closed]:slide-out-to-bottom data-[state=open]:slide-in-from-bottom':
            props.side === 'bottom',
          'left-0 top-0 bottom-0 w-3/4 data-[state=closed]:slide-out-to-left data-[state=open]:slide-in-from-left':
            props.side === 'left',
          'right-0 top-0 bottom-0 w-3/4 data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right':
            props.side === 'right',
